...
tags:
  ...
  - vms
  - coding agents
excerpt: You get an orchestrator, you get an orchestrator, we all get one
---

I wanted to jot down some things I have learned while building out [rubbish](https://github.com/edwinavalos/rubbish), a project built on [firecracker](https://github.com/firecracker-microvm/firecracker) vms running agents in a VM sandbox.

* *Durable execution* -- I resisted introducing a proper workflow engine into the project to learn the rough edges of having to write your own agent scheduler and executor. It was very fragile and was breaking easily. Using a project like [Temporal](https://temporal.io) now makes sense to me.
...
* *Steering hooks* -- The [eval numbers are very impressive from the AWS side](https://strandsagents.com/blog/steering-accuracy-beats-prompts-workflows/), I am building out a copy of it for myself to learn what the edges are as well, and hope to achieve such adherence, but I'm excited to find out where the rough edges are, and why certain decisions get made in the creation of steering hooks.
